...
model_path = hf_hub_download(repo_id="SSudhar/machine_failure_modelv2", filename="best_machine_failure_model_v2.joblib")
model = joblib.load(model_path)

# Streamlit UI for Machine Failure Prediction
st.title("Machine Failure Prediction App - Version 2")
st.write("""
...
torque = st.number_input("Torque (Nm)", min_value=0.0, max_value=100.0, value=60.0, step=0.1)
tool_wear = st.number_input("Tool Wear (min)", min_value=0, max_value=300, value=30)
